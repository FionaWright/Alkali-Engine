...
public:
	...
	void Render(D3DClass* d3d, ID3D12GraphicsCommandList2* cmdList, const int& backBufferIndex, XMMATRIX& view, XMMATRIX& proj, Frustum* frustum, RenderOverride* override = nullptr, bool* requireCPUGPUSync = nullptr, Shader* asyncShader = nullptr);
	void RenderTrans(D3DClass* d3d, ID3D12GraphicsCommandList2* cmdList, const int& backBufferIndex, XMMATRIX& view, XMMATRIX& proj, Frustum* frustum, RenderOverride* override = nullptr, bool* requireCPUGPUSync = nullptr, Shader* asyncShader = nullptr);
