...
public:
	...
	void Render(D3DClass* d3d, ID3D12GraphicsCommandList2* cmdListDirect, const RootParamInfo& rpi, const int& backBufferIndex, bool* requireCPUGPUSync = nullptr, MatricesCB* matrices = nullptr, RenderOverride* renderOverride = nullptr, Shader** lastSetShader = nullptr);
