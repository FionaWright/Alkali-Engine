...
public:
	...
	static UINT AddCBVs(D3DClass* d3d, ID3D12GraphicsCommandList2* cmdListDirect, const vector<UINT>& sizes, vector<ID3D12Resource*>& cbvResources, bool sharing, string id = "");
