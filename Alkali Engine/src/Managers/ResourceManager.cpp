...
void ResourceManager::CreateCommittedResourceAsCommon(ComPtr<ID3D12Resource>& pDestinationResource, size_t numElements, size_t elementSize, D3D12_RESOURCE_FLAGS flags)
{
    assert(gs_device);
