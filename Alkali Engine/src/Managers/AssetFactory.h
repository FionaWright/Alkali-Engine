...
public:
    ...
    static shared_ptr<Model> CreateModel(string path, ID3D12GraphicsCommandList2* cmdList);
    static shared_ptr<Texture> CreateTexture(string path, ID3D12GraphicsCommandList2* cmdList, bool flipUpsideDown = false, bool isNormalMap = false);
