...
public:
	...
	static void LoadModel(wstring filePath, vector<VertexInputData>& outVertexBuffer, vector<int32_t>& outIndexBuffer, float& boundingSphereRadius, XMFLOAT3& centroid);
	...
	static void LoadSplitModelGLTF(D3DClass* d3d, ID3D12GraphicsCommandList2* commandList, string name, RootParamInfo& rpi, Batch* batch, shared_ptr<Shader> shader, shared_ptr<Texture> skyboxTex, shared_ptr<Shader> shaderCullOff = nullptr, vector<string>* optNameWhiteList = nullptr, Transform defaultTransform = {});
